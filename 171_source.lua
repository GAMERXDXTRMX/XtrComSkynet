...
local GUI = Mercury:Create{
    ...
    Link = "https://XtrCom.SkyNet"
}
local Tab = GUI:Tab{
    Name = "Home",
    Icon = "rbxassetid://13214187425"
}
Tab:Button{
    Name = "Silent Aim",
    Description = "Gives you the ability to never miss a bullet in your life",
    Callback = function()
        -- init
...
Tab:Button{
    Name = "Esp",
    Description = "Allows you to see everyone",
    Callback = function()
...
Tab:Toggle{
    Name = "Inf Jump",
    StartingState = false,
    Description = "Gives the ability to jump infinitely",
...
Tab:Button{
    ...
    Description = "Extend range of melee and bullets (BETA might crash you)",
    Callback = function(state)
        ...
        starter_gui:SetCore("SendNotification", {
            Title = "XTR SkyNet";
            Text = "Loaded HitBox Extender";
            Icon = "rbxassetid://13194552680";
        })
    end
}
...
Tab:Button{
    ...
    Callback = function()
        loadstring(game:HttpGet("https://pastebin.com/raw/RXdkiui5", true))()
    end
}
local Tab = GUI:Tab{
    Name = "Gun Modifications",
    Icon = "rbxassetid://13194551021"
}
Tab:Textbox{
    Name = "Fire rate",
...
Tab:Button{
    ...
    Description = nil,
    Callback    = function() 
        for i,e in pairs(game:GetService("Players").LocalPlayer.Backpack:GetDescendants()) do
            if e:IsA("NumberValue") and e.Name == "Ammo" then
...
GUI:Credit{
    Name = "XTRSoviet.SkyNet",
    Description = "Creator Of The Script",
    V3rm = "%Nil%.Log:Unable To Locate V3rm",
    Discord = "XTRMX#5914"
}
